...
urlpatterns = [
    ...
    # Utilities Field
    path('api/v1/utils', ChoicesView.as_view(), name='utils'),

    # Audit trail routes (API)
    path('api/v1/audit/log', AuditLogView.as_view(), name='audit_trail'),
    ...
    # Biller routes (API)
    path('api/v1/biller/create', CreateBillerView.as_view(), name='create_biller'),
    path('api/v1/biller/update', UpdateBillerView.as_view(), name='update_biller'),

    # Product routes (API)
    path('api/v1/product/create', CreateProductView.as_view(), name='create_product'),
    path('api/v1/product/list', GetProductView.as_view(), name='get_product'),
    path('api/v1/product/disable', DisableProductView.as_view(), name='disable_product'),
    ...
    path('api/v1/mandates/process', ProcessMandateView.as_view(), name='process_mandate'),
    path('api/v1/mandates/fetch', FetchMandateView.as_view(), name='fetch_mandates'),
    path('api/v1/mandates', MandateListView.as_view(), name='list_mandates'),
